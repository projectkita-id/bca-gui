...
class SettingsDialog(ctk.CTkToplevel):
    ...
    def _build_ui(self):
        ...
        desc = ctk.CTkLabel(
            main_frame,
            text="Select which scanners should be validated\nChecked scanners will be compared with JSON data",
        ...
        info_label = ctk.CTkLabel(
            info_frame,
            text="💡 Demo mode: Only selected scanners will be validated",
...
class App(ctk.CTk):
    ...
    def _commit_current_item(self):
        ...
        print(f"📦 ITEM SAVED - ID: {self.current_item['item_id']}")
        self.current_item = None
        self.current_item_id = None
    ...
    def start_system(self):
        ...
        print("Press '1' for FAIL | Press '2' for PASS")
        print("=" * 60)
