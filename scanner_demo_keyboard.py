...
class App(ctk.CTk):
    ...
    def _reset_ui(self):
        ...
        print("   Press '1' for FAIL sample")
        print("   Press '2' for PASS sample")
        print("=" * 60)
    ...
    def start_system(self):
        ...
        print("=" * 60)
        print("📝 KEYBOARD MENU:")
        print("   Press '1' → Load FAIL sample")
        print("   Press '2' → Load PASS sample")
        print("=" * 60)
    ...
    def on_key(self, event):
        """Handle keyboard input for demo menu"""
